...
from .modules.utils import style_unvisited_edge, style_visited_edge, style_active_edge, style_path_edge, plot_graph, create_simple_graph
...
def dijkstra(graph: MultiDiGraph, simple_graph: Dict[int, Node], source: int, destination: int, plot=False) -> bool:
  for edge in graph.edges:
