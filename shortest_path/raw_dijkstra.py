...
from .modules.utils import style_unvisited_edge, style_visited_edge, style_active_edge, style_path_edge, plot_graph, plot_graph_raw, reconstruct_path, create_simple_graph, clean_max_speed, convert_multidigraph_to_graph
from .modules.simple_graph import Node, RawNode, NodeId, Edge, EdgeId, Graph
...
def reconstruct_path_raw(G: MultiDiGraph, graph: Graph, source: NodeId, destination: NodeId, path: Dict[NodeId, Optional[NodeId]]):
  dist: float = 0
  time: float = 0
